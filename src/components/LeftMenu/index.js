...
const LeftMenu = () => {
  ...
  return (
    <div
      className={
        leftMenu ? "container-left-menu active" : "container-left-menu"
      }
    >
      <ul className="ul-left-menu">
        <li className="li-left-menu">
          <Link to="/">
            <img src={PaginaInicialIcone} alt="home" title="Tela inicial" />
          </Link>
        </li>
        <li className="li-left-menu">
        ...
        <li className="li-left-menu">
          <Link to="/">
            <img src={CaminhaoIcone} alt="" title="Visualizar historico" />
          </Link>
        </li>
        <li className="li-left-menu">
          <Link to="/contact">
